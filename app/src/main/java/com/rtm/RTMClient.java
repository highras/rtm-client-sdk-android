...
public class RTMClient {
     ...
     */
    public void sendMessage(long to, byte mtype, String msg, String attrs, int timeout, FPCallback.ICallback callback) {
     ...
     * @callback {Map}               payload
     */
    public void sendMessages(List<Long> tos, byte mtype, String msg, String attrs, int timeout, FPCallback.ICallback callback) {
     ...
     * @callback {Map}               payload
     */
    public void sendGroupMessage(long gid, byte mtype, String msg, String attrs, int timeout, FPCallback.ICallback callback) {
     ...
     * @callback {Map}               payload
     */
    public void sendRoomMessage(long rid, byte mtype, String msg, String attrs, int timeout, FPCallback.ICallback callback) {
     ...
     * @callback {Map}               payload
     */
    public void sendFile(byte mtype, long to, byte[] fileBytes, int timeout, FPCallback.ICallback callback) {
     ...
     * @callback {Map}               payload
     */
    public void sendFiles(byte mtype, List<Long> tos, byte[] fileBytes, int timeout, FPCallback.ICallback callback) {
     ...
     * @callback {Map}               payload
     */
    public void sendGroupFile(byte mtype, long gid, byte[] fileBytes, int timeout, FPCallback.ICallback callback) {
     ...
     * @callback {Map}               payload
     */
    public void sendRoomFile(byte mtype, long rid, byte[] fileBytes, int timeout, FPCallback.ICallback callback) {
        ...
        this.sendQuest(data, new FPCallback.ICallback() {
            ...
            public void callback(FPCallback fpcb) {
                ...
                if (exception != null) {
                    ...
                    self._rtmClient.close(exception);
                    return;
                }
